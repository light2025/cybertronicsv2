...
insert into categories (id, title, slug, parent_category, icon, position) values
  ...
  ('11111111-1111-1111-1111-000000000003', 'Headwear',             'headwear',           null, '🧢', 30),
  ('11111111-1111-1111-1111-000000000004', 'Full Costume Combo',   'full-costume-combo', null, '🥋', 40),
  ('11111111-1111-1111-1111-000000000005', 'Footwear',             'footwear',           null, '👟', 50),
  ('11111111-1111-1111-1111-000000000006', 'Accessories',          'accessories',        null, '🕶️', 60),
  ('11111111-1111-1111-1111-000000000007', 'Shirts',               'shirts',             null, '👔', 15),
  ('11111111-1111-1111-1111-000000000008', 'Bottomwear',           'bottomwear',         null, '🩳', 25),
  ('11111111-1111-1111-1111-000000000009', 'Underwear',            'underwear',          null, '🩲', 35)
